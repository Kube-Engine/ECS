...
requires std::derived_from<System, kF::ECS::ASystem<EntityType>> &&
    std::constructible_from<System, Args...> inline System &
    kF::ECS::SystemGraph<EntityType>::add(Args &&... args) noexcept(nothrow_ndebug &&nothrow_constructible(System, Args...))
{
...
requires std::derived_from<System, kF::ECS::ASystem<EntityType>> inline bool kF::ECS::SystemGraph<EntityType>::exists(void) const noexcept
{
...
template <typename EntityType>
template <typename System>
requires std::derived_from<System, kF::ECS::ASystem<EntityType>> inline const System &kF::ECS::SystemGraph<EntityType>::get(void) const
{
    const auto systemTypeID = typeid(System);
    const auto it = std::find_if(_systems.begin(), _systems.end(), [systemTypeID](SystemPtr<EntityType> &systemPtr) {
        return systemPtr->typeID() == systemTypeID;
